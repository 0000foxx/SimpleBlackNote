...
public class All_List extends Activity
{
    ...
    void loadAccountDetail()
    {
        ...
        for (int i = 0; i < accountdetailcount; i++) {
            ...
            al.add(new AccountDetail(sp.getString("ad_time" + i, ""), sp.getString("ad_money" + i,
                    ""), sp.getString("ad_remark" + i, "")));
            ...
            public void onClick(View v)
            {
                ...
                as.addListener(new AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation)
                    {
                        ...
                        // �I����s2����檺�ʧ@
                        ValueAnimator rotationY = ObjectAnimator.ofFloat(bmore, "scaleY", 0.0f,
                                1.0f);
                        // ValueAnimator rotationX = ObjectAnimator.ofFloat(bexit, "rotationX", 0f,
                        // 360f);
                        rotationY.setDuration(250);
                        // rotationX.setDuration(500);
            ...
            public void onClick(View v)
            {
                ...
                as.addListener(new AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation)
                    {
                        ...
                        // // exit AlertDialog
                        AlertDialog ad = new AlertDialog.Builder(All_List.this,
                        ...
                        ad.setButton("�T�w", new DialogInterface.OnClickListener() {// �]�w���s1
                                    ...
                                    public void onClick(DialogInterface dialog, int which)
                                    {
                                        ...
                                        //
                                        // // Uri uri =
                                        // Uri.parse("https://play.google.com/store/apps/developer?id=Vulpse");
                        ...
                        ad.setButton2("���", new DialogInterface.OnClickListener() {// �]�w���s2
                                    ...
                                    public void onClick(DialogInterface dialog, int which)
                                    {
                                        ...
                                        // �I����s2����檺�ʧ@
                                        ValueAnimator rotationY = ObjectAnimator.ofFloat(bexit,
                                                "scaleY", 0.0f, 1.0f);
                                        // ValueAnimator rotationX = ObjectAnimator.ofFloat(bexit,
                                        // "rotationX", 0f, 360f);
                                        rotationY.setDuration(250);
                                        // rotationX.setDuration(500);
        ...
        if (requestCode == 0) {
            ...
            // no edit
                ...
                case 1:
                    ...
                    sa = new SimpleAdapter(All_List.this, list, R.layout.test2, new String[] {
                            "str1", "str2", "str3"
                    }, new int[] {
                            R.id.date, R.id.money, R.id.detail
                    });
    ...
    void callNowalcount(int chnum)
    {
        ...
        if (chnum == 1) {
            ...
            // use AlertDialog
            AlertDialog ad = new AlertDialog.Builder(All_List.this, AlertDialog.THEME_TRADITIONAL)
                    .create();
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                switch (which) {
                    ...
                    case 3:
                        ...
                        ad.setButton2("�T�w", new DialogInterface.OnClickListener() {// �]�w���s2
                                    ...
                                    public void onClick(DialogInterface dialog, int which)
                                    {
                                        ...
                                        spe3.clear();
                                        spe3.putInt("adcount", accountdetailcount);// for more
                                                                                   // putXXX
                                                                                   // function
                                                                                   // for (int i =
                                                                                   // 0; i <
                    ...
                    case 5:
                        ...
                        // use AlertDialog
                        AlertDialog ad2 = new AlertDialog.Builder(All_List.this,
                                AlertDialog.THEME_TRADITIONAL).create();
    ...
    void showNotificationOnScreenTop()
    {
        ...
        Intent it = new Intent(this, MainTableActivity.class);
