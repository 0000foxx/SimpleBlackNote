...
public class Table_Flow extends TabActivity{
	...
	void initView(){
		...
		Intent inte1 = new Intent(this, All_List.class);//清單
		Intent inte2 = new Intent(this, Month_List.class);//本月
		Intent inte3 = new Intent(this, Today_List.class);//本日
		Intent inte4 = new Intent(this, Week_List.class);//本周
